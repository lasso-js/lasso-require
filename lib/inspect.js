...
exports.inspectCached = function (path, reader, lastModified, optimizerContext, config, callback) {
    var debugEnabled = logger.isDebugEnabled();

    ok(path, '"path" is required');
    ok(reader, '"reader" is required');
    ok(lastModified, '"lastModified" is required');
    ...
    ok(typeof lastModified === 'function', '"lastModified" should be a function');
    ...
    lastModified(function(err, lastModified) {
