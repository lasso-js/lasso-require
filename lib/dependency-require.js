...
function create(config, optimizer) {
    ...
    return {
        ...
        getDependencies: function(optimizerContext, callback) {
            ...
            var asyncPackageName = this.getAsyncPackageName();
            var requireContextKey = (asyncPackageName || '') + '|' + 'dependency-require';
            

            var requireContext = optimizerContext.attributes[requireContextKey] || (optimizerContext.attributes[requireContextKey] = {
