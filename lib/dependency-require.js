...
var CLIENT_OPTIMIZER_JSON_PATH = require.resolve('raptor-modules/client/browser.json');
    ...
    return {
        ...
        init: function(optimizerContext, callback) {
            ...
            if (this._resolved) {
                ...
                resolver.resolveRequire(path, from, fromFile, options, optimizerContext, function(err, resolved) {
                    if (err) {
                        return callback(err);
                    }
        ...
        getDependencies: function(optimizerContext, callback) {
            ...
            function getDependenciesFromInspected(err, inspected) {
                ...
                if (main) {
                    ...
                    var optimizerJsonPath = nodePath.join(nodePath.dirname(resolved.filePath), 'browser.json');
