...
exports.resolveInspectedRequires = function resolveInspectedRequires(inspected, from, fromFile, options, callback) {
    ok(inspected, '"inspected" is required');
    equal(typeof from, 'string', '"from" should be a string');
    ...
    function handleRequire(require) {
        asyncTasks.push(function(callback) {
            exports.resolveRequire(require.path, from, fromFile, options, function(err, resolved) {
                if (err) {
                    return callback(err);
                }
