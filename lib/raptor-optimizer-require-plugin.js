...
module.exports = exports = function plugin(optimizer, config) {
    ...
    optimizer.on('optimizerCacheCreated', function(cacheInfo) {
        ...
        optimizerCache.configureCacheDefaults({
            '*': { // Any profile
                'raptor-optimizer-require/inspect': {
                    store: 'disk',
                    encoding: 'utf8',
                    valueType: 'json'
                },
                'raptor-optimizer-require/transformed': {
                    store: 'disk',
                    singleFile: false,
                    encoding: 'utf8'
                }
    ...
    optimizer.dependencies.registerRequireExtension('json', {object: true}, require('./json-reader'));
